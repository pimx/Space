...
package Transformations
  ...
  algorithm
    ...
    N := a / sqrt(1 - e2*sin_lat^2);
    alt := p/cos_lat - N;
  end ECEF_to_geodetic;
  
  function rotation_ECEF_to_NED
  ...
  protected
    Real lat, lon, alt;
  algorithm
    (lat, lon, alt) := ECEF_to_geodetic(r_origin_ECEF);
    R := rotation_ECEF_to_NED(lat, lon);
  ...
  function position_ECEF_to_Local
  ...
  algorithm
    ...
    r_local := R * dr_ECEF;
  end position_ECEF_to_Local;
  
  function position_Local_to_ECEF
  ...
  function position_ECI_to_Local
  ...
  algorithm
    ...
    r_local := position_ECEF_to_Local(r_ECEF, r_origin_ECEF);
  end position_ECI_to_Local;
  
  function position_Local_to_ECI
  ...
  protected
    Real r_ECEF[3];
  algorithm
    r_ECEF := position_Local_to_ECEF(r_local, r_origin_ECEF);
    r_ECI := position_ECEF_to_ECI(r_ECEF, t);
  end position_Local_to_ECI;
  
  function velocity_ECEF_to_Local
  ...
  end velocity_ECEF_to_Local;
  
  function velocity_Local_to_ECEF
  ...
  function velocity_ECI_to_Local
  ...
  algorithm
    ...
    v_local := velocity_ECEF_to_Local(r_ECEF, v_ECEF, r_origin_ECEF);
  end velocity_ECI_to_Local;
  
  function velocity_Local_to_ECI
  ...
  algorithm
    r_ECEF := position_Local_to_ECEF(r_local, r_origin_ECEF);
    v_ECEF := velocity_Local_to_ECEF(r_ECEF, v_local, r_origin_ECEF);
    v_ECI := velocity_ECEF_to_ECI(r_ECEF, v_ECEF, t);
  end velocity_Local_to_ECI;
  function force_ECEF_to_Local
  ...
  algorithm
    R := rotation_matrix_from_origin(r_origin_ECEF);
    F_local := R * F_ECEF;
  end force_ECEF_to_Local;
  
  function force_Local_to_ECEF
  ...
  algorithm
    ...
    F_local := R * F_ECI;
  end force_ECI_to_Local;
  
  function force_Local_to_ECI
